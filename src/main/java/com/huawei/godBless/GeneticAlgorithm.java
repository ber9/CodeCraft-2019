...
public class GeneticAlgorithm {
    //开始遗传
    SpeciesIndividual run(List<List<Path>> carPaths) {
        //创建初始种群
        SpeciesPopulation list = createBeginningSpecies(carPaths);
    ...
    //创建初始种群
    SpeciesPopulation createBeginningSpecies(List<List<Path>> carPaths){
        SpeciesPopulation list = new SpeciesPopulation();
        //100%随机
